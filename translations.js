...
const translations = {
    ...
    'zh-TW': {
        ...
        'feature-1': '✅ 用直球對決與自媒體，打造屬於你的事業系統！',
        'feature-2': '✅ 從零開始，用直球對決開啟你的創業人生！',
        'feature-3': '✅ 不需要懂技術，不需要大資金，只要願意學、願意行動',
        'feature-4': '✅ 下一波創業潮，不是開店、不是加盟，而是「直球對決」',
        'original-price': '直球對決',
        ...
        'audience-1-text': '🌍 在這個直球對決時代，你不需要等待別人給你機會。現在，人人都能用直球對決打造個人品牌、開啟第二收入，即使沒有技術、沒有團隊，也能靠直球對決創造被動收入！',
        'audience-2-title': '做招商加盟的你',
        'audience-2-subtitle': '保險團隊 / 微商 / 餐飲招商',
        'audience-2-text': '🌍 我們幫助你建立一套完整的「直球對決」——從直球對決應用、內容行銷、品牌打造，到獲利變現，一步步帶你從0開始，找到你的人生新方向。',
        'audience-3-title': '每天上班打卡的你',
        'audience-3-subtitle': '行政 / 會計 / 助理 / 客服 / 行銷 / 內勤業務 / 社群小編',
        'audience-3-text': '🌍 無論你是媽媽、上班族、自由工作者、或剛起步的創業者，只要你願意學習、願意改變，這套系統就能讓你用直球對決放大你的能力，讓世界看見你、聽見你、並願意為你的價值付費。',
        ...
        'testimonial-3-text': '高壓力的工作環境下，如果沒有樂觀的心態，真的很難撐下去，很開心遇到直球對決，本來還擔心太複雜，沒想到有團隊幫忙，不只找到方法與機會，還可以學會最先進的直球對決與自媒體變現能力，真的太棒了。',
        ...
        // 表單
        'modal-title': '🎉 立即獲取優惠',
        'modal-subtitle': '填寫資料，開始您的直球對決之旅',
    ...
    'zh-CN': {
        ...
        'feature-1': '✅ 用直球对决与自媒体，打造属于你的事业系统！',
        'feature-2': '✅ 从零开始，用直球对决开启你的创业人生！',
        'feature-3': '✅ 不需要懂技术，不需要大资金，只要愿意学、愿意行动',
        'feature-4': '✅ 下一波创业潮，不是开店、不是加盟，而是「直球对决」',
        'original-price': '直球对决',
        ...
        'audience-1-text': '🌍 在这个直球对决时代，你不需要等待别人给你机会。现在，人人都能用直球对决打造个人品牌、开启第二收入，即使没有技术、没有团队，也能靠直球对决创造被动收入！',
        'audience-2-title': '做招商加盟的你',
        'audience-2-subtitle': '保险团队 / 微商 / 餐饮招商',
        'audience-2-text': '🌍 我们帮助你建立一套完整的「直球对决」——从直球对决应用、内容营销、品牌打造，到获利变现，一步步带你从0开始，找到你的人生新方向。',
        'audience-3-title': '每天上班打卡的你',
        'audience-3-subtitle': '行政 / 会计 / 助理 / 客服 / 营销 / 内勤业务 / 社群小编',
        'audience-3-text': '🌍 无论你是妈妈、上班族、自由工作者、或刚起步的创业者，只要你愿意学习、愿意改变，这套系统就能让你用直球对决放大你的能力，让世界看见你、听见你、并愿意为你的价值付费。',
        ...
        'testimonial-3-text': '高压力的工作环境下，如果没有乐观的心态，真的很难撑下去，很开心遇到直球对决，本来还担心太复杂，没想到有团队帮忙，不只找到方法与机会，还可以学会最先进的直球对决与自媒体变现能力，真的太棒了。',
        'faq-title': '常见问题',
        'faq-q1': '可以试试看吗？',
        ...
        'modal-title': '🎉 立即获取优惠',
        'modal-subtitle': '填写资料，开始您的直球对决之旅',
    ...
    'en': {
        ...
        'feature-1': '✅ Build Your Own Business System with Straight Showdown & Social Media!',
        'feature-2': '✅ Start from Zero, Launch Your Entrepreneurial Journey with Straight Showdown!',
        'feature-3': '✅ No Technical Skills or Capital Required, Just Learn & Take Action',
        'feature-4': '✅ The Next Wave of Entrepreneurship: Straight Showdown',
        ...
        'audience-1-text': '🌍 In this Straight Showdown era, you don\'t need to wait for opportunities. Now, everyone can use Straight Showdown to build a personal brand and create a second income, even without technical skills or a team!',
        'audience-2-title': 'Franchise & Network Marketers',
        'audience-2-subtitle': 'Insurance Teams / MLM / Food & Beverage Franchises',
        'audience-2-text': '🌍 We help you build a complete "Straight Showdown" — from Straight Showdown applications, content marketing, brand building, to monetization, guiding you step by step from zero to find your new direction in life.',
        ...
        'audience-3-text': '🌍 Whether you\'re a parent, employee, freelancer, or startup entrepreneur, as long as you\'re willing to learn and change, this system will help you amplify your abilities with Straight Showdown, letting the world see you, hear you, and pay for your value.',
        ...
        'after-1': '✅ Create customized Straight Showdown systems to build your business SOP',
        ...
        'modal-subtitle': 'Fill in your information to start your Straight Showdown journey',
